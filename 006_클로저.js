...
outer();
// 호출할 때마다 다시 생성되고 휘발되고의 반복
// 위의 값들은 호출되고 휘발되어 버린다
...
var newInner = outer(); // newInner라는 변수에 휘발되지 않게 저장하여 함수안에 계속 접근 할수 있다
newInner();
